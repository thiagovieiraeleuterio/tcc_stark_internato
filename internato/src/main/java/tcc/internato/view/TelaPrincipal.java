...
public class TelaPrincipal extends JFrame {
	...
	public TelaPrincipal() {
		...
		JMenu mnOcorrncia = new JMenu("Ocorrência   ");
		mnOcorrncia.setFont(new Font("Segoe UI Semibold", Font.PLAIN, 14));
		menuBar.add(mnOcorrncia);
		
		JMenuItem mntmNovaOcorrncia = new JMenuItem("Nova Ocorrência");
		mntmNovaOcorrncia.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Ocorrencia ocorrencia = new Ocorrencia();
				ocorrencia.run();
			}
		});
		mnOcorrncia.add(mntmNovaOcorrncia);
		
		JMenuItem mntmBuscarOcorrncia = new JMenuItem("Buscar Ocorrência");
		mnOcorrncia.add(mntmBuscarOcorrncia);
